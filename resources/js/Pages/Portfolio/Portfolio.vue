  ...
  <article class="mb-8">
    <div class="flex items-center">
      <svg viewBox="0 0 48 48" class="w-6 stroke-cyan-500">
        ...
        <line x1="18" y1="15" x2="30" y2="15" fill="none" stroke-linecap="round" stroke-linejoin="round"
          stroke-width="4" />
        <line x1="18" y1="23" x2="30" y2="23" fill="none" stroke-linecap="round" stroke-linejoin="round"
          stroke-width="4" />
      </svg>
